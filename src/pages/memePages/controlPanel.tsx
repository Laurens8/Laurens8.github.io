...
const { slide, layout, theme, color, setColor, setLayout, setSlide, setTheme } = props;
    ...
    return (
         <div className="controlPanel">
          ...
          <hr className={theme} style={{ marginTop: '2rem', marginBottom: '2rem' }} />
          <div>
            <p style={{marginBottom: '1rem'}}>Layout</p>
            <Button style={{marginRight: '1rem'}}
               color={color === 'warning' ? 'warning' : 'secondary' &&
                color === 'secondary' ? 'secondary' : 'warning' &&
          ...
          <div style={{display: 'grid'}}>
            ...
            <Button style={{marginBottom: '1rem'}}
              color={color === 'warning' ? 'warning' : 'success' &&
               color === 'secondary' ? 'secondary' : 'success' &&
            ...
            >
              success
               ...
               <Button
              color={color === 'warning' ? 'warning' : 'danger' &&
